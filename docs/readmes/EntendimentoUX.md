...
| **Critérios de aceitação** 	| - **Critério 1**: É necessário alimentar o algoritmo com o arquivo CSV com os comentários que serão analisados. <br><br>- **Critério 2**: É necessário que o algoritmo reconheça os dados tratados e dê início à etapa de modelagem. 	|
| **Testes de aceitação** 	| - **Teste 1  para o critério 1**:  O funcionário tenta alimentar o algoritmo com dados no formato correto:<br>    - Conseguiu: correto.<br>    - Não conseguiu: incorreto, é necessário que essa funcionalidade seja corrigida.<br><br>- **Teste 2 para o critério 1:** O funcionário tenta alimentar o algoritmo com dados no formato incorreto, só deve ser aceito CSV ou Excel: <br>    - Conseguiu: incorreto, é necessário que haja uma condicional que impeça a adição de dados no formato incorreto.<br>    - Não conseguiu: correto.<br><br>- **Teste 1 para o critério 2**: O funcionário tenta alimentar o algoritmo com os dados não tratados:<br>    - Conseguiu: incorreto, não deve ser possível rodar o algoritmo com dados não tratados, esse erro precisa ser corrigido.<br>    - Não conseguiu: correto. 	|
