...
| **História** 	| Eu, como funcionário da área de automação, tratamentos dos dados sejam escolhidos com enfoque no objetivo da análise do sentimento, a depender da sua finalidade. 	|
| **Critérios de aceitação** 	| **Critério 1:** É necessário que os tratamentos dos dados sejam escolhidos para realizar um Bag of Words que mostre <br><br> **Critério 2:** É necessário que seja escolhido um número mínimo de parâmetros, sendo esse maior que 1.{retirada de acentos, retirada de artigos, tratamento emojs} <br><br> **Critério 3:** É necessário que haja uma indicação dos melhores métodos a serem utilizados para um resultado específico (isso pode estar estruturado em comentários no código). 	|
