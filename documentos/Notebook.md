...
Também foi gerada uma nuvem de palavras utilizando a base de dados que apenas passou pelo processo de tokenização, sem nenhum outro pré-processamento, para ressaltar a diferença de uma nuvem de palavras que usa um bag of words com um conjunto totalmente bruto, sem remoção de stop words, nem padronização de palavras.
